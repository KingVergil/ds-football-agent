...
export function registerReplayTool(deps) {
  ...
  registerTool({
    ...
    parameters: {
      ...
      pause_every: { type: "number", description: ">0 时按天暂停（每天跑完停一次，不触发因子退役；自动开启半交互），默认 0=不按天停" },
