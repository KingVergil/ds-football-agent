...
PROD = Path("/Users/cjy/Desktop/code/ds_agents/lota_data/roles")
PROD_DATA = Path("/Users/cjy/Desktop/code/ds_agents/lota_data")
OLD_RETEST = Path("/private/tmp/ds_retest_old/lota_data/roles")
OLD_RETEST_DATA = Path("/private/tmp/ds_retest_old/lota_data")
DEDUP_RETEST = Path("/private/tmp/ds_retest/lota_data/roles")
DEDUP_RETEST_DATA = Path("/private/tmp/ds_retest/lota_data")
LO = date(2026, 7, 15)
HI = date(2026, 7, 25)
